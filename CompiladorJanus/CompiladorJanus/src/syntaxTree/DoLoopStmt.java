 ...
 * @author VBrum
 */
public class DoLoopStmt extends Statement {
    ...
    public DoLoopStmt(Exp ae1, Exp ae2, StatementList asl1, StatementList asl2, int lineNum1, int charNum1, int lineNum2, int charNum2) {
        e1 = ae1;
        e2 = ae2;
        sl1 = asl1;
        sl2 = asl2;
